...
CCDBFILE=/home/gluex2/gluexdb/ccdb_2021_11_03.sqlite
RCDBFILE=/home/gluex2/gluexdb/rcdb_2021_11_03.sqlite
...
source $BUILD_SCRIPTS/gluex_env_version.sh /home/gluex2/gluex_top/halld_versions/version_5.7.1.xml

#source /home/gluex2/gluex_top/gluex_env_boot.sh
#source /home/gluex2/gluex_top/gluex_env_cmu.sh
...
export rootcmd=process_this_run.C\($RUN,$PROOFTHREADS,\"$TREEFILE\",\"$TREENAME\",\"$DSELNAME\"\)
...
if [ -f ${ROOTFILE1} ]; then
        cp ${ROOTFILE1} ${OUT_FlatTree}/${ROOTFILE1_target}
