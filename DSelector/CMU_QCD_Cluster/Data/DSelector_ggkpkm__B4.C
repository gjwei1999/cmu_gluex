...
void DSelector_ggkpkm__B4::Init(TTree *locTree)
{
	...
	dFlatTreeFileName = "tree_ggkpkm__B4.root"; //output flat tree (one combo per tree entry), "" for none
	...
	*/
	...
	dFlatTreeInterface->Create_Branch_Fundamental<Float_t>("M_FinalState");
...
Bool_t DSelector_ggkpkm__B4::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i){
        ...
        Int_t numFinalState = 4;//proton k+ k- pi0
        Double_t locWeight = 1.0;

		//Fill flatTree
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Weight", locWeight);
		...
		dFlatTreeInterface->Fill_Fundamental<Int_t>("PID_FinalState", 11, 1);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("E_FinalState", locKPlusP4_KinFit.E(), 1);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Px_FinalState", locKPlusP4_KinFit.Px(), 1);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Py_FinalState", locKPlusP4_KinFit.Py(), 1);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Pz_FinalState", locKPlusP4_KinFit.Pz(), 1);
		dFlatTreeInterface->Fill_Fundamental<Int_t>("PID_FinalState", 12, 2);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("E_FinalState", locKMinusP4_KinFit.E(), 2);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Px_FinalState", locKMinusP4_KinFit.Px(), 2);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Py_FinalState", locKMinusP4_KinFit.Py(), 2);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Pz_FinalState", locKMinusP4_KinFit.Pz(), 2); 
		dFlatTreeInterface->Fill_Fundamental<Int_t>("PID_FinalState", 7, 3);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("E_FinalState", locPi0P4_KinFit.E(), 3);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Px_FinalState", locPi0P4_KinFit.Px(), 3);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Py_FinalState", locPi0P4_KinFit.Py(), 3);
		dFlatTreeInterface->Fill_Fundamental<Float_t>("Pz_FinalState", locPi0P4_KinFit.Pz(), 3);

		dFlatTreeInterface->Fill_Fundamental<Float_t>("M_FinalState", M_FinalState); 
